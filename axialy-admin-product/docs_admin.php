<?php
// /home/i17z4s936h3j/public_html/admin.axiaba.com/docs_admin.php
...
<head>
  <meta charset="UTF-8">
  <title>AxiaBA Admin - Documentation</title>
  <style>
    body {
...
<body>
  ...
  <div id="left-panel" class="expanded">
    <div id="panel-header">
      <a href="index.php">
        <img src="https://axiaba.com/assets/img/SOI.png" alt="AxiaBA Logo" style="cursor: pointer;"/>
      </a>
      <h1>Docs</h1>
    </div>
