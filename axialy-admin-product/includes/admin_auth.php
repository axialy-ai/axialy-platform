<?php
// /home/i17z4s936h3j/public_html/admin.axiaba.com/includes/admin_auth.php
require_once __DIR__ . '/AdminDBConfig.php';
use AxiaBA\AdminConfig\AdminDBConfig;

/**
 * Ensures the admin session is valid in AxiaBA_ADMIN.admin_user_sessions,
...
function requireAdminAuth()
{
    ...
    // Query AxiaBA_ADMIN DB for admin_user_sessions
