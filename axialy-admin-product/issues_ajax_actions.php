...
// For retrieving Admin info from AxiaBA_ADMIN
...
function sendEmail(PDO $pdo) {
    ...
    // We'll do a quick fetch from AxiaBA_ADMIN to get the logged in admin's email.
    ...
    // Subject:
    // e.g. "AxiaBA Support Ticket #123 - [Issue Title]"
    $subject = "AxiaBA Support Ticket #{$issueId} - {$issueTitle}";
...
Thank you for using AxiaBA. If you have any follow-up,
